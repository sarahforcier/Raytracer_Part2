...
{
    Material* lambert1 = new PhongMaterial(glm::vec3(1, 0, 0));
    Material* lambert2 = new PhongMaterial(glm::vec3(0, 1, 0));
    Material* lambert3 = new PhongMaterial(glm::vec3(1, 1, 1));
    Material* lightMat = new PhongMaterial(glm::vec3(1,1,1)); lightMat->emissive = true;
